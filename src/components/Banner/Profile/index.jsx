...
import { banner as bannerIcon } from '@const/icons';
...
export default class Profile extends PureComponent {
  ...
  openImageViewer = () => {
    ...
    this.imageViewer.show(entry.cover, (
      <ImageViewer.Title
        icon={bannerIcon}
        title={entry.title}
        avatar={toProcessImage(entry.cover, { w: 64, h: 64 })}
      />
    ));
  }
  ...
  fetchEntry = async () => {
    ...
    try {
      ...
      const { [entryProp]: entry } = await this.fetchBannerProfile(entryId);
