...
export default class Detail extends PureComponent {
  ...
  render() {
    ...
    const statistius = [
      { key: '浏览', value: entry.views.toLocaleString() },
      { key: '收藏', value: entry.collections.toLocaleString() },
      { key: '喜欢', value: entry.favourites.toLocaleString() }
    ];

    return (
      <Fragment>
        <HeaderInfo values={statistius} />
